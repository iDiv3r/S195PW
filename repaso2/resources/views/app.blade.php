        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link fs-5 {{ request()->routeIs('rInicio')?'text-danger fw-bold ' : 'text-dark' }} " aria-current="page" href="{{ route('rInicio') }}">Inicio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fs-5 {{ request()->routeIs('rRegistro')?'text-danger fw-bold ' : 'text-dark' }}" href="{{ route('rRegistro') }}">Registro</a>
                    </li>
                </ul>
