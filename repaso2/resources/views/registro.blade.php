            ...
            <form action="{{ route('regL') }}" method="POST">
                ...
                <div class="d-flex justify-content-around">
                    ...
                    <div class="my-3 px-3">
                        ...
                        <input  type="number" min="1" step="1" onkeypress="return event.charCode >= 48" class="form-control" id="formGroupExampleInput" placeholder="...">
                    </div>
                    <div class="my-3 px-3">
                        <label for="formGroupExampleInput2" class="form-label">Año</label>
                        <input  type="number" min="1" step="1" onkeypress="return event.charCode >= 48" class="form-control" id="formGroupExampleInput2" placeholder="...">
                    </div>
                </div>

                <div class="my-3">
                    <label for="formGroupExampleInput" class="form-label">E-mail de la Editorial</label>
                    <input  type="mail" class="form-control" id="formGroupExampleInput" placeholder="...">
                </div>
